namespace SpriteKind {
    export const Invinsible = SpriteKind.create()
}
...
sprites.onDestroyed(SpriteKind.Invinsible, function (sprite) {
...
scene.onOverlapTile(SpriteKind.Player, sprites.dungeon.hazardLava1, function (sprite, location) {
    mySprite.setKind(SpriteKind.Invinsible)
...
scene.onOverlapTile(SpriteKind.Player, assets.tile`chest1`, function (sprite, location) {
    ...
    mySprite.say("Time for Level 2!!", 500)
})
...
game.splash("You have 4 min to finish", "Try to get all the points")
game.splash("I will let you figure out the rest", "Good Luck and have fun!!! MUAHHAHAHHAHAHAH")
